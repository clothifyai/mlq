...
class MLQ():
    ...
    def __init__(self, q_name, redis_host, redis_port, redis_db, redis_pw):
        self.q_name = q_name
        ...
        self.id = str(uuid())
        self._redis = redis.StrictRedis(host=redis_host, port=redis_port, db=redis_db, password='rRSnTQE9q5UU', decode_responses=False)
